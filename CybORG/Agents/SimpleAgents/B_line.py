    ...
    def get_action(self, observation, action_space):
        ...
        while True:
            ...
            # Discover Remote Systems
                ...
                initial_host = [x for x in observation if x.startswith('User')][0]
                self.initial_ip = observation[initial_host]['Interface'][0]['IP Address']
                self.last_subnet = observation[initial_host]['Interface'][0]['Subnet']
