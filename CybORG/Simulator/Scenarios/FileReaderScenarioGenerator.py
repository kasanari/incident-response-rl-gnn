...
class FileReaderScenarioGenerator(ScenarioGenerator):
    ...
    def __init__(self, file_path: str):
        ...
        with open(self.file_path, encoding="utf8") as fIn:
        ...
        with open(images_file_path + 'images.yaml', encoding="utf8") as fIn:
        ...
        if scenario_dict is not None:
            for hostname, image in scenario_dict["Hosts"].items():
                if 'path' in images_dict[image["image"]]:
                    with open(images_file_path + images_dict[image["image"]]['path'] + '.yaml', encoding="utf8") as fIn2:
        ...
        if 'Scenario1b' in self.file_path or 'Scenario2' in self.file_path:
            ...
            with open(f'{cyborg_path[:-7]}/render/render_data_old_scenario.json', 'r',  encoding="utf8") as f:
                data = json.load(f)
